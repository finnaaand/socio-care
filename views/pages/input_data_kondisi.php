...
<section class="content">
    <form action="data_kondisi_rumah" method="POST">
        <a href="data_kondisi_rumah" class="btn text-light" style="background-color: #40A578;"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>

        <!-- Default box -->
        <div class="card mt-3">
            <div class="card-header" style="background-color: #40A578;">
