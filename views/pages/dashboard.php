<div class="content-header" style="background-image: url('dist/img/700px-City_of_Surabaya_Logo.svg.png'); background-size: 60px; background-position: center; background-repeat: no-repeat;">
...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-4">
        <div class="info-box mb-3 bg-gradient-green">
        ...
        <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="small-box bg-light">
                ...
                <h3 style="color: darkgreen;">
                    ...
                    <p class="text-black"><?= $rows_dusun['dusun'] ?></p>
                </div>
                <div class="icon">
                    <i class="ion ion-home text-green"></i>
                </div>
            </div>
        </div>
        <?php
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card card-light">
                    ...
                    <div class="card-body">
                        <div class="chart">
                            <canvas id="Jumlah_donasi" width="400" height="400"></canvas>
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
...
<?php
// Ambil total donasi dari database
$sql_total_donasi = $mysqli->query("SELECT SUM(jumlah_donasi) AS total_donasi FROM donasi");
$row_total_donasi = $sql_total_donasi->fetch_assoc();
$total_donasi = $row_total_donasi['total_donasi'];
?>

<script>
    var ctx = document.getElementById('Jumlah_donasi').getContext('2d');
    var JumlahDonasi = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Total Donasi'],
            datasets: [{
